...
const GPS_RETRY_EXTREME_METERS = Number(process.env.GPS_RETRY_EXTREME_METERS || 500);
const GPS_RETRY_POOR_METERS = Number(process.env.GPS_RETRY_POOR_METERS || 300);
const GPS_WEAK_THRESHOLD_METERS = Number(process.env.GPS_WEAK_THRESHOLD_METERS || 150);
